    ...
    <div>
      ...
      <Routes>
        <Route
          path="/"
          element={
            <Landingpage user={user} blogFormRef={blogFormRef} />
          }
        />
        ...
        <Route
          path="/login"
          element={<LoginForm blogFormRef={blogFormRef} />}
        />
      </Routes>
    </div>
  )
